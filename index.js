...
async function getTemplate(moduleId,templateId) {
    ...
    if(moduleId && templateId){
        let response = await fetch(`https://api.wolfeocrm.com/v1/setting/${moduleId.typeId}/template/${templateId.formId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJMVENCV1M4RkRVTkdTMDNUIiwiaXNzIjoiaHR0cHM6Ly9hcGkuaWxvZ2dlcnouY29tL2FwaS92MS9sb2dpbiIsImlhdCI6MTY3Nzg1ODIzMiwiZXhwIjoxNjc3ODYxODMyLCJuYmYiOjE2Nzc4NTgyMzIsImp0aSI6IkxUQ0JXUzhGRFVOR1MwM1QxNjc3ODU4MjMyIn0.1Q3d_GuSVMdnhVjGeXDITRWaDvuHGmYpt-Ei1QRf5d8'
            }
        }).then(async (res) => {
        data = await res.json();
